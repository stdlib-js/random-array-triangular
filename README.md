...
```javascript
import triangular from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-triangular@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-triangular/tags). For example,

```javascript
import triangular from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-triangular@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-triangular@esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/random-array-triangular/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/random-array-triangular/actions/workflows/test.yml?query=branch:v0.2.1
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-triangular.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-triangular/main
...
[deno-readme]: https://github.com/stdlib-js/random-array-triangular/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-array-triangular/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-array-triangular/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-array-triangular/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-array-triangular/blob/esm/README.md
